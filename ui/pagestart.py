...
class PageStart(tk.Frame):
    ...
    def __init__(self, root):
        ...
        buttonSelectUser.grid(row=1, column=0, sticky="EW", ipadx=10)
        # Manage users button
        buttonManageUsers = ttk.Button(self, text="Manage Users")
        buttonManageUsers.grid(row=2, column=0, sticky="EW", ipadx=10)
        # Exit button
        buttonExit = ttk.Button(self, text="Exit", command=lambda:sys.exit())
        buttonExit.grid(row=3, column=0, sticky="EW", ipadx=10)