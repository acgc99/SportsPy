...
from ui import Page
from ui.widgets import FrameScrollable
...
class PageManage(Page):
    ...
    def _initialize(self):
            ...
            self.frames["data"] = tk.Frame(self, highlightbackground="black", highlightthickness=1)
            self.frames["data"].grid(row=0, column=0)
            
            self.labels["data_year"] = ttk.Label(self.frames["data"], text="Year")
            self.labels["data_year"].grid(row=0, column=0)
            
            self.labels["data_month"] = ttk.Label(self.frames["data"], text="Month")
            self.labels["data_month"].grid(row=0, column=1)
            
            self.labels["data_day"] = ttk.Label(self.frames["data"], text="Day")
            self.labels["data_day"].grid(row=0, column=2)
            
            self.labels["data_distance"] = ttk.Label(self.frames["data"], text="Distance")
            self.labels["data_distance"].grid(row=0, column=3)
            
            self.labels["data_time"] = ttk.Label(self.frames["data"], text="Time")
            self.labels["data_time"].grid(row=0, column=4)
            
            self.labels["data_kcal"] = ttk.Label(self.frames["data"], text="Kcal")
            self.labels["data_kcal"].grid(row=0, column=5)
            
            self.labels["data_idsession"] = ttk.Label(self.frames["data"], text="Session id")
            self.labels["data_idsession"].grid(row=0, column=6)
            
            self.labels["data_actions"] = ttk.Label(self.frames["data"], text="Actions")
    ...
    def _initialize_dataframe(self, i, runningSession, idsession):
        ...
        self.entries["data_year"] = ttk.Entry(self.frames["data"])
        ...
        self.entries["data_month"] = ttk.Entry(self.frames["data"])
        ...
        self.entries["data_day"] = ttk.Entry(self.frames["data"])
        ...
        self.entries["data_distance"] = ttk.Entry(self.frames["data"])
        ...
        self.entries["data_time".format(idsession)] = ttk.Entry(self.frames["data"])
        ...
        self.entries["data_kcal"] = ttk.Entry(self.frames["data"])
        ...
        self.entries["data_idsession"] = ttk.Entry(self.frames["data"])
        ...
        self.buttons["data_edit"] = ttk.Button(self.frames["data"], text="Edit")
        ...
        self.buttons["data_delete"] = ttk.Button(self.frames["data"], text="Delete")
